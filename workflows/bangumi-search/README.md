...
Search Bangumi subjects from Alfred via `bangumi-cli` (API-first path), then open selected subject pages in your browser.
...
| `BANGUMI_QUERY_CACHE_TTL_SECONDS` | Optional same-query cache TTL (seconds). Default `10`. |
