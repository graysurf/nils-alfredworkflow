...
Run core `nils-codex-cli@0.3.8` operations from Alfred.
...
- `.alfredworkflow` bundles `codex-cli@0.3.8` (release-coupled runtime version).
...
```bash
cargo install nils-codex-cli --version 0.3.8
```
...
- Official package should bundle exactly `codex-cli@0.3.8`.
