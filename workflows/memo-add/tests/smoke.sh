...
assert_jq_json "$packaged_json" '.connections | length == 8' "connection wiring mismatch"
assert_jq_json "$packaged_json" '[.objects[] | select(.type == "alfred.workflow.trigger.hotkey")] | length == 1' "hotkey trigger count mismatch"
