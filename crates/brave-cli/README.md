...
| `brave-cli query` | `--input <QUERY_OR_TOKEN>` | Two-stage query mode: plain text returns an Enter-to-load direct-result row plus Google suggestions; `res::<query>` returns Brave web results. |
