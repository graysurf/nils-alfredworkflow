...
| [Market Expression](workflows/market-expression/README.md) | `mx`, `market` | Evaluate market expressions (numeric: `+ - * /`, assets: `+ -`) with FX/crypto conversion and copy selected rows. | Optional: `MARKET_DEFAULT_FIAT` |
