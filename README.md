...
| [Memo Add](workflows/memo-add/README.md) | `mm` | Add memo text quickly into sqlite storage, with optional one-click db init and latest-record preview. | Optional tuning: `MEMO_DB_PATH`, `MEMO_SOURCE`, `MEMO_REQUIRE_CONFIRM`, `MEMO_MAX_INPUT_BYTES`, `MEMO_RECENT_LIMIT`, `MEMO_WORKFLOW_CLI_BIN` |
